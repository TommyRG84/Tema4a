//4. Crea las clases Punto, Triangulo, Circulo y Rectangulo. Un punto tiene dos
...
/**
 * Representamos un triángulo en el plano
 */

public class Triangulo {
  
  /**
   *  Representamos el primer vertice.
   */
  
  public Punto primerVertice;
  
  /**
   *  Representamos el segundo vertice.
   */
  
  public Punto segundoVertice;
  
  /**
   *  Representamos el tercer vertice.
   */
  
  public Punto tercerVertice;
